...
// const searchApiRes = 'https://api.giphy.com/v1/gifs/search?api_key=nhTKuYXaMk6fp1e6S3Ts68zTe4nEmEN0&q='+userInputRes+'&limit=50'
const searchApiRes = 'https://api.giphy.com/v1/gifs/search?api_key=nhTKuYXaMk6fp1e6S3Ts68zTe4nEmEN0&q='+userInputRes+'& limit=50'


let searchGiphyRes = function(){
    fetch(searchApiRes).then((response)=>{
        if(response.ok){
